...
class HipDataNotificationRequestNotification(BaseModel):
    ...
    hi_types: List[HITypeEnum] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "patient": HipDataNotificationRequestNotificationPatient.from_dict(
                    obj["patient"]
                )
                ...
                "date": obj.get("date"),
                "hip": HipDataNotificationRequestNotificationHip.from_dict(obj["hip"])
