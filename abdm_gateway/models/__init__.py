...
from abdm_gateway.models.consent_artefact_response_consent import (
    ConsentArtefactResponseConsent,
)
from abdm_gateway.models.consent_artefact_response_consent_consent_detail import (
    ConsentArtefactResponseConsentConsentDetail,
)
from abdm_gateway.models.consent_artefact_response_consent_consent_detail_consent_manager import (
...
from abdm_gateway.models.consent_request_consent_patient import (
    ConsentRequestConsentPatient,
)
from abdm_gateway.models.consent_request_init_response import ConsentRequestInitResponse
from abdm_gateway.models.consent_request_init_response_consent_request import (
...
from abdm_gateway.models.hip_consent_notification_notification import (
    HIPConsentNotificationNotification,
)
from abdm_gateway.models.hip_consent_notification_notification_consent_detail import (
    HIPConsentNotificationNotificationConsentDetail,
)
from abdm_gateway.models.hip_consent_notification_notification_consent_detail_care_contexts_inner import (
    HIPConsentNotificationNotificationConsentDetailCareContextsInner,
)
from abdm_gateway.models.hip_consent_notification_notification_consent_detail_consent_manager import (
    HIPConsentNotificationNotificationConsentDetailConsentManager,
)
from abdm_gateway.models.hip_consent_notification_notification_consent_detail_hip import (
    HIPConsentNotificationNotificationConsentDetailHip,
)
from abdm_gateway.models.hip_consent_notification_response import (
    HIPConsentNotificationResponse,
)
from abdm_gateway.models.hiphi_request import HIPHIRequest
from abdm_gateway.models.hip_health_information_request_acknowledgement import (
    HIPHealthInformationRequestAcknowledgement,
)
from abdm_gateway.models.hip_health_information_request_acknowledgement_hi_request import (
...
from abdm_gateway.models.hiu_consent_notification_event import (
    HIUConsentNotificationEvent,
)
from abdm_gateway.models.hiu_consent_notification_event_notification import (
    HIUConsentNotificationEventNotification,
)
from abdm_gateway.models.hiu_consent_notification_response import (
    HIUConsentNotificationResponse,
)
from abdm_gateway.models.hiu_consent_request_status import HIUConsentRequestStatus
from abdm_gateway.models.hiu_consent_request_status_consent_request import (
    HIUConsentRequestStatusConsentRequest,
)
from abdm_gateway.models.hiu_health_information_request_response import (
    HIUHealthInformationRequestResponse,
)
from abdm_gateway.models.hiu_health_information_request_response_hi_request import (
...
from abdm_gateway.models.hiu_subscription_event_content import (
    HIUSubscriptionEventContent,
)
from abdm_gateway.models.hiu_subscription_notification import (
    HIUSubscriptionNotification,
)
from abdm_gateway.models.hiu_subscription_notification_acknowledgment import (
    HIUSubscriptionNotificationAcknowledgment,
)
from abdm_gateway.models.hiu_subscription_notification_acknowledgment_acknowledgement import (
    HIUSubscriptionNotificationAcknowledgmentAcknowledgement,
)
from abdm_gateway.models.hiu_subscription_notification_event import (
    HIUSubscriptionNotificationEvent,
)
from abdm_gateway.models.hiu_subscription_request_notification_acknowledgement import (
    HIUSubscriptionRequestNotificationAcknowledgement,
)
from abdm_gateway.models.hiu_subscription_request_notification_acknowledgement_acknowledgement import (
    HIUSubscriptionRequestNotificationAcknowledgementAcknowledgement,
)
from abdm_gateway.models.hiu_subscription_request_receipt import (
    HIUSubscriptionRequestReceipt,
)
from abdm_gateway.models.health_information_notification import (
    HealthInformationNotification,
)
from abdm_gateway.models.health_information_notification_notification import (
    HealthInformationNotificationNotification,
)
from abdm_gateway.models.health_information_notification_notification_notifier import (
    HealthInformationNotificationNotificationNotifier,
)
from abdm_gateway.models.health_information_notification_notification_status_notification import (
    HealthInformationNotificationNotificationStatusNotification,
)
from abdm_gateway.models.health_information_notification_notification_status_notification_status_responses_inner import (
...
from abdm_gateway.models.hip_data_notification_acknowledgement import (
...
from abdm_gateway.models.hip_data_notification_request_notification import (
    HipDataNotificationRequestNotification,
)
from abdm_gateway.models.hip_data_notification_request_notification_hip import (
    HipDataNotificationRequestNotificationHip,
)
from abdm_gateway.models.hip_data_notification_request_notification_patient import (
...
from abdm_gateway.models.link_confirmation_request_confirmation import (
...
from abdm_gateway.models.patient_auth_confirm_response_auth import (
    PatientAuthConfirmResponseAuth,
)
from abdm_gateway.models.patient_auth_init_request import PatientAuthInitRequest
from abdm_gateway.models.patient_auth_init_request_query import (
    PatientAuthInitRequestQuery,
)
from abdm_gateway.models.patient_auth_init_response import PatientAuthInitResponse
from abdm_gateway.models.patient_auth_init_response_auth import (
    PatientAuthInitResponseAuth,
)
from abdm_gateway.models.patient_auth_mode_query_request import (
    PatientAuthModeQueryRequest,
)
from abdm_gateway.models.patient_auth_mode_query_request_query import (
    PatientAuthModeQueryRequestQuery,
)
from abdm_gateway.models.patient_auth_mode_query_request_query_requester import (
    PatientAuthModeQueryRequestQueryRequester,
)
from abdm_gateway.models.patient_auth_mode_query_response import (
    PatientAuthModeQueryResponse,
)
from abdm_gateway.models.patient_auth_mode_query_response_auth import (
    PatientAuthModeQueryResponseAuth,
)
from abdm_gateway.models.patient_auth_notification import PatientAuthNotification
from abdm_gateway.models.patient_auth_notification_acknowledgement import (
    PatientAuthNotificationAcknowledgement,
)
from abdm_gateway.models.patient_auth_notification_acknowledgement_acknowledgement import (
    PatientAuthNotificationAcknowledgementAcknowledgement,
)
from abdm_gateway.models.patient_auth_notification_auth import (
...
from abdm_gateway.models.patient_care_context_link_patient import (
...
from abdm_gateway.models.patient_care_context_link_response import (
    PatientCareContextLinkResponse,
)
from abdm_gateway.models.patient_care_context_link_response_acknowledgement import (
...
from abdm_gateway.models.patient_identification_request import (
    PatientIdentificationRequest,
)
from abdm_gateway.models.patient_identification_request_query import (
    PatientIdentificationRequestQuery,
)
from abdm_gateway.models.patient_identification_request_query_patient import (
    PatientIdentificationRequestQueryPatient,
)
from abdm_gateway.models.patient_identification_request_query_requester import (
    PatientIdentificationRequestQueryRequester,
)
from abdm_gateway.models.patient_identification_response import (
    PatientIdentificationResponse,
)
from abdm_gateway.models.patient_identification_response_patient import (
    PatientIdentificationResponsePatient,
)
from abdm_gateway.models.patient_link_reference_request import (
...
from abdm_gateway.models.patient_link_reference_result_link import (
...
from abdm_gateway.models.patient_sms_notifcation_request import (
    PatientSMSNotifcationRequest,
)
from abdm_gateway.models.patient_sms_notifcation_request_notification import (
    PatientSMSNotifcationRequestNotification,
)
from abdm_gateway.models.patient_sms_notifcation_request_notification_hip import (
    PatientSMSNotifcationRequestNotificationHip,
)
from abdm_gateway.models.patient_sms_notifcation_response import (
    PatientSMSNotifcationResponse,
)
from abdm_gateway.models.patient_status_notification import PatientStatusNotification
from abdm_gateway.models.patient_status_notification_notification import (
    PatientStatusNotificationNotification,
)
from abdm_gateway.models.patient_status_notification_notification_patient import (
...
from abdm_gateway.models.share_profile_acknowledgement import (
    ShareProfileAcknowledgement,
)
from abdm_gateway.models.share_profile_acknowledgement1 import (
...
from abdm_gateway.models.share_profile_request_profile_patient import (
...
from abdm_gateway.models.subscription_approval_notification import (
    SubscriptionApprovalNotification,
)
from abdm_gateway.models.subscription_approval_notification_notification import (
...
from abdm_gateway.models.subscription_request_subscription import (
