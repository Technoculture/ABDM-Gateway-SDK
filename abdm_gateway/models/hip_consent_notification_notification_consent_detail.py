        ...
        _obj = cls.model_validate(
            {
                ...
                "careContexts": [
                    HIPConsentNotificationNotificationConsentDetailCareContextsInner.from_dict(
                        _item
                    )
                ...
                "hip": HIPConsentNotificationNotificationConsentDetailHip.from_dict(
                    obj["hip"]
                )
                if obj.get("hip") is not None
                else None,
                "consentManager": HIPConsentNotificationNotificationConsentDetailConsentManager.from_dict(
                    obj["consentManager"]
                )
