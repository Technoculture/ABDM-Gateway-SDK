...
class PatientSMSNotifcationRequestNotification(BaseModel):
    ...
    phone_no: StrictStr = Field(
        description="Phone number of the receiver with country code", alias="phoneNo"
    )
    receiver_name: Optional[StrictStr] = Field(
        default=None,
        description="Name of the reciever/patient. Receiver's name will not be sent if not provided.",
        alias="receiverName",
    )
    care_context_info: StrictStr = Field(
        description="Information about care context or visit for which the SMS is being sent.",
        alias="careContextInfo",
    )
    deeplink_url: Optional[StrictStr] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "hip": PatientSMSNotifcationRequestNotificationHip.from_dict(obj["hip"])
