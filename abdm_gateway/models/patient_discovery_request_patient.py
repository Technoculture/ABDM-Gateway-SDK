...
class PatientDiscoveryRequestPatient(BaseModel):
    ...
    unverified_identifiers: Optional[List[Identifier]] = Field(
        default=None, alias="unverifiedIdentifiers"
    )
    name: StrictStr
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "verifiedIdentifiers": [
                    Identifier.from_dict(_item) for _item in obj["verifiedIdentifiers"]
                ]
                if obj.get("verifiedIdentifiers") is not None
                else None,
                "unverifiedIdentifiers": [
                    Identifier.from_dict(_item)
                    for _item in obj["unverifiedIdentifiers"]
                ]
                if obj.get("unverifiedIdentifiers") is not None
                else None,
                "name": obj.get("name"),
